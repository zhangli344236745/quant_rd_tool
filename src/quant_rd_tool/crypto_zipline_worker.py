"""Subprocess entry: run zipline backtest in .venv-zipline (JSON stdin → JSON stdout)."""
...
from quant_rd_tool.crypto_zipline_zipline_engine import run_zipline_backtest_inprocess
